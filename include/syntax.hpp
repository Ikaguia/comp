...
struct AST {
	using TYPE = enum {
		NUMBER, BOOLEAN, LITERAL, VARTYPE, PARENTHESIS,
		OP1, OP2, OP3, OP4, OP5, OP6, OP7, OP8, OP9, OP10, OP11, OP12, OP13, OP14, OP15,
		FDECLARATION, DECLARATION, DECLARATIONS, IF, IFELSE, WHILE, DOWHILE,
		FUNC, FUNCPAR, FUNCPARS, FUNCDEC, FUNCDECPAR, FUNCDECPARS, ARG, ARGS, NARG, NARGS, NFUNCCALL, RETURN,
		STRUCT, STRUCTPROPS,
		EXPRESSION, STATEMENT, BLOCK, CODE, COUNT
	};
